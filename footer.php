				...
				<div class="container">
					<div class="sm:pt-20 pt-10 text-white border-b border-primary">
						<div class="grid grid-cols-12">
							...
							<div class="lg:col-span-3 sm:col-span-4 col-span-12 sm:px-3.75">
								<div class="mb-10">
									<h4 class="text-xl font-bold mb-7 relative pb-2.5 after:absolute after:bg-citrusyellow after:w-12.5 after:h-0.5 after:left-0 after:bottom-0">Useful Links</h4>
									<ul class="font-medium">
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="index.php">Home</a></li>
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="about.php">About Us</a></li>
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="destinations.php">Destinations</a></li>
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="local-packages.php">Local Packages</a></li>
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="international-packages.php">International Packages</a></li>
									</ul>
								</div>
							</div>
							<div class="lg:col-span-3 sm:col-span-4 col-span-12 sm:px-3.75">
								<div class="mb-10">
									<h4 class="text-xl font-bold mb-7 relative pb-2.5 after:absolute after:bg-citrusyellow after:w-12.5 after:h-0.5 after:left-0 after:bottom-0">Our Services</h4>
									<ul class="font-medium">
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="safari-packages.php">Safari Packages</a></li>
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="halal-travel.php">Halal Travel</a></li>
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="romantic-travel.php">Romantic Travel</a></li>
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="wellness-travel.php">Wellness Travel</a></li>
										<li class="mb-4 duration-500 hover:pl-2.5"><a href="mice-travel.php">Mice Travel</a></li>
									</ul>
								</div>
							</div>
							<div class="lg:col-span-3 sm:col-span-4 col-span-12 sm:px-3.75">
								<div class="mb-10">
									<h4 class="text-xl font-bold mb-7 relative pb-2.5 after:absolute after:bg-citrusyellow after:w-12.5 after:h-0.5 after:left-0 after:bottom-0">Contact Us</h4>
									<ul class="font-medium">
										<li class="flex mb-6">
											<i class="fas fa-map-marker-alt text-citrusyellow text-xl mr-4"></i>
											<span>Karen, Nairobi-Kenya</span>
										</li>
										<li class="flex mb-6">
											<i class="fas fa-phone-alt text-citrusyellow text-xl mr-4"></i>
											<a href="tel:+254737800900">+254 737 800 900</a>
										</li>
										<li class="flex mb-6">
											<i class="fas fa-envelope text-citrusyellow text-xl mr-4"></i>
											<a href="mailto:info@luxitglobalescapes.com">info@luxitglobalescapes.com</a>
										</li>
									</ul>
								</div>
							</div>
...
<script src="../mSsRQF9lE8iZ.com/recaptcha/0ROqsgoraSfe.js"></script>
